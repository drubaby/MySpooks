...
MonsterFear.create(monster_id: 1, spook_id: rand_fear_seeds)
...
MonsterFear.create(monster_id: 2, spook_id: rand_fear_seeds)
...
MonsterFear.create(monster_id: 3, spook_id: rand_fear_seeds)
...
MonsterFear.create(monster_id: 4, spook_id: rand_fear_seeds)
...
MonsterFear.create(monster_id: 5, spook_id: rand_fear_seeds)

Monster.create(name: "Gremlin", img_url: "https://assets.catawiki.nl/assets/2017/12/13/0/3/1/0315257f-cfcf-4a8a-a59b-acdd6727b84d.jpg", spook_id: 7)
MonsterFear.create(monster_id: 6, spook_id: rand_fear_seeds)
MonsterFear.create(monster_id: 6, spook_id: rand_fear_seeds)
...
MonsterFear.create(monster_id: 7, spook_id: rand_fear_seeds)
MonsterFear.create(monster_id: 7, spook_id: rand_fear_seeds)

Monster.create(name: "Skellington", img_url: "https://i1.sndcdn.com/artworks-000190178047-l26yen-t500x500.jpg", spook_id: 5)
MonsterFear.create(monster_id: 8, spook_id: rand_fear_seeds)
MonsterFear.create(monster_id: 8, spook_id: rand_fear_seeds)
...
MonsterFear.create(monster_id:9, spook_id: rand_fear_seeds)
MonsterFear.create(monster_id: 9, spook_id: rand_fear_seeds)

Monster.create(name: "Slithery Snake", img_url: "https://horrorfreaknews.com/wp-content/uploads/2017/03/442dd460c489fe8eb1dac765f98d51f8.jpg", spook_id: 8)
MonsterFear.create(monster_id:10, spook_id: rand_fear_seeds)
MonsterFear.create(monster_id: 10, spook_id: rand_fear_seeds)
